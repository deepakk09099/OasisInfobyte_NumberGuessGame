...
public class NumberGuessGame {
    ...
    public static void main(String[] args) {
        ...
        for(int i=1; i<=MAX_ROUNDS; i++) {
            ...
            System.out.printf("\nCurrent Round: %d: Guess the number between %d and %d in %d attemps.",i, MIN_RANGE,MAX_RANGE,MAX_ATTEMPTS);
            ...
            while (current_attempts < MAX_ATTEMPTS) {
                ...
                if(guess_number == number) {
                    ...
                    totalscore =+ score;
                    System.out.printf("Congrates! You successfully guessed the number. Attempts: %d. Round score: %d\n", current_attempts, score);
                    break;
                } 
            ...
            if(current_attempts == MAX_ATTEMPTS) {
                System.out.printf("You lost in the Round = %d. Attempts = 0\n", i);
